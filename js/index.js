...
function handleScrollStep(scrollStep) {
  ...
  if (scrollStep === 86 && lastScrollStep !== 86) {
    ...
    if (!document.querySelector(".ray2-text")) {
      const ray2 = document.createElement("div");
      ray2.className = "ray2-text";
      ray2.textContent = "RAY2";

      Object.assign(ray2.style, {
        position: "absolute",
        bottom: "460px",
        left: "81%",
      ...
      setTimeout(() => {
        ray2.style.transform = "translateX(-50%) scale(1)";
        ray2.style.opacity = "1";
      }, 100);
    }

    let luma = document.querySelector(".luma-text");
    if (!luma) {
      luma = document.createElement("div");
      luma.className = "luma-text";
      luma.textContent = "Luma";

      Object.assign(luma.style, {
        position: "absolute",
        bottom: "30px",
        left: "60px",
      ...
      setTimeout(() => {
        luma.style.transform = "translateY(0) scale(1)";
        luma.style.opacity = "1";
      }, 100);
    }

    setTimeout(() => {
      const luma = document.querySelector(".luma-text");
      if (luma && !document.querySelector(".ray2-description")) {
        const desc = document.createElement("div");
        desc.className = "ray2-description";
        desc.innerHTML = `
        <span style="color: white; font-weight: bold;">Ray2</span> is a large-scale video generative model. It marks the beginning of a new generation of video models capable of producing fast coherent motion, ultra-realistic details, and logical event sequences. This increases the success rate of usable generations and makes videos generated by Ray2 substantially more production-ready.
      `;
    ...
    if (!document.querySelector(".dm-scroll-wrapper")) {
      const wrapper = document.createElement("div");
      wrapper.className = "dm-scroll-wrapper";
      ...
      const container = document.createElement("div");
      container.className = "dm-scroll-container";
      ...
      const DMVideosAndPhotos = [
        "../img/vd/DMv_01_Desktop_smaller.mp4",
        "../img/vd/DMv_02_Desktop_smaller.mp4",
        "../img/vd/DMv_03_Desktop_smaller.mp4",
        "../img/vd/DMv_04_Desktop_smaller.mp4",
        "../img/vd/Dmv_05_desktop_smaller.mp4",
        "../img/vd/Dmv_06_desktop_smaller.mp4",
        "../img/DMI_01_Desktop.webp",
        "../img/DMI_02_Desktop.webp",
        "../img/DMI_03_Desktop.webp",
        "../img/DMI_04_Desktop.webp",
        "../img/DMI_05_Desktop.webp",
        "../img/DMI_06_Desktop.webp",
      ];
      ...
      scrollbarThumb.id = "scrollbarThumb";
      ...
      style.textContent = `
      .dm-scroll-wrapper::-webkit-scrollbar {
        display: none;
      }
      .dm-scroll-wrapper {
    ...
    `;
      ...
      wrapper.addEventListener("mousedown", (e) => {
        ...
        if (
          ...
          dragCursor.style.color = "#fff";
          dragCursor.innerText = "Dragging ↔";
      ...
      function updateScrollbar() {
        ...
        const thumbWidth = (clientWidth / scrollWidth) * 150;

        scrollbarThumb.style.width = `${Math.max(thumbWidth, 20)}px`;
        scrollbarThumb.style.transform = `translateX(${
          scrollPercentage * (150 - thumbWidth)
        }px)`;
      }
      ...
      dragCursor.className = "dm-drag-cursor";
      dragCursor.innerText = "Drag ↔";
      ...
      function updateCursor() {
        const offsetX = 30;
        const offsetY = -20;
        cursorX += (mouseX + offsetX - cursorX) * 0.1;
        cursorY += (mouseY + offsetY - cursorY) * 0.1;
  ...
  if (scrollStep < 86 && lastScrollStep === 86) {
    ...
    const ray2 = document.querySelector(".ray2-text");
    if (ray2) ray2.remove();
    ...
    const rangeWrap = document.querySelector(".custom-scrollbar");
    if (rangeWrap) {
      rangeWrap.style.transition = "opacity 0.5s ease, transform 0.5s ease";
      rangeWrap.style.opacity = "0";
      rangeWrap.style.transform = "translateX(-50%) translateY(30px)";
      setTimeout(() => rangeWrap.remove(), 500);
    }

    const dragCursor = document.querySelector(".dm-drag-cursor");
    if (dragCursor) {
      dragCursor.style.transition = "opacity 0.3s ease";
      dragCursor.style.opacity = "0";
      setTimeout(() => dragCursor.remove(), 300);
    }
  }

  const desc = document.querySelector(".ray2-description");
  if (desc) {
    desc.style.transition = "transform 0.6s ease, opacity 0.6s ease";
    desc.style.transform = "scale(0.8) translateY(30px)";
    desc.style.opacity = "0";

    setTimeout(() => desc.remove(), 800);
  }
